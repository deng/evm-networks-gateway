...
SPEC_URL="${1:-https://evm-networks.bithub.pro/openapi.json}"
OUTPUT_DIR="$(cd "$(dirname "$0")/.." && pwd)/evm-networks-gateway-flutter"
...
pubName=evm_networks_gateway,\
pubVersion=0.1.0,\
pubDescription="ZeroWallet EVM Networks Gateway API client for Flutter",\
useJsonKey=true,\
